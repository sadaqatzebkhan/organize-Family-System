...
import { Network, Users, GitFork, ShieldCheck, Menu, X, Search, BookOpen } from 'lucide-react';
          ...
          <div className="flex items-center gap-2.5 sm:gap-3 shrink-0">
            {onOpenPdfModal && (
              <button
                ...
                className="hidden sm:flex items-center gap-1.5 bg-amber-50 text-amber-900 border border-amber-300 rounded px-3 py-1.5 text-xs font-bold hover:bg-amber-100 transition-all shadow-2xs whitespace-nowrap shrink-0"
              >
